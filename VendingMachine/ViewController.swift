...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    //this is the successful path of our code
    ...
    func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        ...
        reset()
        //this helps us determine what the users current selection is
    ...
    //if the current selection property is not nil it is unwrapped an assigned to a constant of the same name
